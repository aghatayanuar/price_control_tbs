frappe.ui.form.on("Harga Beli TBS", {
    onload(frm) {
        frm.set_query("uom", () => {
            ...
            return {
                query: "price_control_tbs.price_control_tbs.doctype.harga_beli_tbs.harga_beli_tbs.item_uom_query",
                filters: {
    ...
    fetch_current_price(frm) {
        ...
        frappe.call({
            method: "price_control_tbs.price_control_tbs.doctype.harga_beli_tbs.harga_beli_tbs.get_current_price",
            args: {
                item_code: frm.doc.item_code,
    ...
    load_price_history(frm, after_load = null) {
        ...
        frappe.call({
            method: "price_control_tbs.price_control_tbs.doctype.harga_beli_tbs.harga_beli_tbs.fetch_price_history",
            args: {
                item_code: frm.doc.item_code,
                // unit: frm.doc.unit,
                // jarak: frm.doc.jarak,
    ...
    apply_price_change(frm) {
        ...
        frappe.confirm(
            ...
            () => {
                frappe.call({
                    method: "price_control_tbs.price_control_tbs.doctype.harga_beli_tbs.harga_beli_tbs.create_price_note_from_harga_beli_tbs",
                    args: {
                        item_code: frm.doc.item_code,
                        unit: frm.doc.unit,
                        supplier: frm.doc.supplier,
...
frappe.ui.form.on("Item Price Control History TBS", {
    approve_btn(frm, cdt, cdn) {
        ...
        frappe.confirm(
            ...
            () => {
                frappe.call({
                    method: "price_control_tbs.price_control_tbs.doctype.harga_beli_tbs.harga_beli_tbs.approve_price_change",
                    args: {
